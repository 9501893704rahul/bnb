@php
    $user = auth()->user();
    $isHousekeeperOnly = $user->hasRole('housekeeper') && !$user->hasAnyRole(['admin', 'owner', 'company']);
...
<x-perfect-scrollbar as="nav" aria-label="main" class="flex flex-col flex-1 gap-4 px-3">
    ...
    {{-- Housekeeper-Only View: My Assignments ONLY --}}
    @if($isHousekeeperOnly)
    ...
    {{-- Everything below is for Admin/Owner/Company ONLY --}}
    @if(!$isHousekeeperOnly)
        ...
        {{-- Assignments (Admin/Owner/Company) --}}
        @if($isAdminOrOwner || $isCompany)
